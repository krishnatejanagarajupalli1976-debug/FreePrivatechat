...
This project is intended for educational and development purposes. Add an appropriate open-source license such as MIT if you want others to freely use, modify, and distribute the project.
